...
personal_info = [
    {
        ...
        "Contact": {
            ...
            "Phone": "https://wa.me/+##########",
            "Location": [
                "https://maps.app.goo.gl/coordinates1",
                "https://maps.app.goo.gl/coordinates2"
            ]
        },
        "Profile": [
            "Years of Experience",
...
<table>
  <tr>
    <td style="vertical-align: left;">
      <h3 style="margin: 0;">OBS Business School</h3>
      <p style="margin: 0; color: gray;">Partner: Universitat de Barcelona (UB)</p>  
      <p style="margin: 0; color: gray;">Master's in Corporate Finance</p>
      <p style="margin: 0; color: gray;"> Dates: 04/2024 - 05/2025 (Expected)</p>
      <ul style="padding-left: 0px;">
        <li>Elected Class President</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td style="vertical-align: left;">
      <h3 style="margin: 0;">Instituto Le Cordon Bleu Perú</h3>
      <p style="margin: 0; color: gray;">Diploma in Restaurant Management</p>
      <p style="margin: 0; color: gray;">Dates: 03/2020 - 06/2022</p>
    </td>
  </tr>
  <tr>
    <td style="vertical-align: left;">
      ...
      <ul style="padding-left: 0px;">
        <li>8th best GPA in the class</li>
      </ul>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td style="vertical-align: left;">
      ...
      <p style="margin: 0; color: gray;">Partner: when applicable</p>  
      <p style="margin: 0; color: gray;">degree title</p>
      <p style="margin: 0; color: gray;"> Dates: start date - end date(Expected)</p>
      <ul style="padding-left: 0px;">
        <li>achievement</li>
      </ul>
    </td>
  ...
  <tr>
    <td style="vertical-align: left;">
      <h3 style="margin: 0;">institution</h3>
      <p style="margin: 0; color: gray;">degree title</p>
      <p style="margin: 0; color: gray;">Dates: start date - end date</p>
    </td>
  </tr>
  <tr>
    <td style="vertical-align: left;">
      <h3 style="margin: 0;">institution</h3>
      <p style="margin: 0; color: gray;">Interexchange: when applicable</p>
      <p style="margin: 0; color: gray;">degree title</p>
      <p style="margin: 0; color: gray;">start date - end date</p>
      <ul style="padding-left: 0px;">
        <li>achievement</li>
      </ul>
    </td>
...
academic_path = {
    "institution": {
        ...
        "Dates": "start date - end date(expected)",
